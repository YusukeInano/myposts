...
var timetable_up = {
  1:{ id:1, hour:6, minute:30, type:3 },
  2:{ id:3, hour:7, minute:0, type:3 },
  3:{ id:5, hour:7, minute:40, type:4 },
  4:{ id:7, hour:8, minute:10, type:5 },
  5:{ id:9, hour:8, minute:40, type:3 },
  6:{ id:11, hour:9, minute:12, type:4 },
  7:{ id:13, hour:9, minute:42, type:1 },
  8:{ id:15, hour:10, minute:12, type:2 },
  9:{ id:17, hour:10, minute:42, type:1 },
  10:{ id:19, hour:11, minute:42, type:2 },
  11:{ id:21, hour:12, minute:12, type:2 },
  12:{ id:23, hour:12, minute:42, type:2 },
  13:{ id:25, hour:13, minute:42, type:2 },
  14:{ id:27, hour:14, minute:42, type:2 },
  15:{ id:29, hour:15, minute:12, type:2 },
  16:{ id:31, hour:15, minute:42, type:2 },
  17:{ id:33, hour:16, minute:42, type:2 },
  18:{ id:35, hour:17, minute:12, type:1 },
  19:{ id:37, hour:17, minute:42, type:1 },
  20:{ id:39, hour:18, minute:12, type:2 },
  21:{ id:41, hour:18, minute:42, type:2 },
  22:{ id:43, hour:19, minute:12, type:2 },
  23:{ id:45, hour:19, minute:27, type:1 },
  24:{ id:47, hour:20, minute:7, type:5 },
  25:{ id:49, hour:20, minute:54, type:1 },
};

// 駅の到着時間にパターンがあったので、パターンにした
var traintype = {
  1:{"Osaka":0, "SinOsaka":4, "Takatsuki":14, "Katsuragawa":22, "Kyoto":27},
  2:{"Osaka":0, "SinOsaka":4, "Takatsuki":14, "Katsuragawa":23, "Kyoto":28},
  3:{"Osaka":0, "SinOsaka":4, "Takatsuki":14, "Katsuragawa":24, "Kyoto":29},
  4:{"Osaka":0, "SinOsaka":4, "Takatsuki":15, "Katsuragawa":25, "Kyoto":30},
  5:{"Osaka":0, "SinOsaka":4, "Takatsuki":15, "Katsuragawa":26, "Kyoto":31},
};
...
function setTrainPosition(){
  ...
  //発車時刻+Kyoto＜現在時刻＜発車時刻　の場合に電車を非表示
　// 駅の位置を微調整する
  var target_after = "";
  var target_before = "";
  var stationtime = "";
