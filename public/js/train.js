...
function setTrainPosition() {
  ...
  console.log(timetablekey); //発車時刻+SinOsaka＜現在時刻＜発車時刻　の場合に電車を非表示
  // 駅の位置を微調整する
  ...
  document.getElementById('home').innerHTML = '桂川駅' + katsutime + '通過'; //発車時刻＜=現在時刻＜=発車時刻+Kyoto の場合に電車を表示
...
/***/ 6:
/*!*************************************!*\
  !*** multi ./resources/js/train.js ***!
  \*************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! /home/ec2-user/environment/myposts/resources/js/train.js */"./resources/js/train.js");
